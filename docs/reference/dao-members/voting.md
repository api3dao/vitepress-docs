...
path: /reference/dao-members/voting.html
outline: deep
tags:
  - dao
  - voting
...
See the
[Api3Voting.sol<ExternalLinkImage/>](https://github.com/api3dao/api3-dao/blob/main/packages/api3-voting/contracts/Api3Voting.sol)
