...
path: /reference/airnode/v0.11/specifications/airnode-abi.html
version: v0.11
outline: deep
tags:
---
...
user should use the
[`bytes32`](/reference/airnode/v0.11/specifications/airnode-abi.md#bytes32) type
instead.
...
[`string32`](/reference/airnode/v0.11/specifications/airnode-abi.md#string32)
type instead.
...
[template](/reference/airnode/v0.11/concepts/template.md) pattern used in the
...
[airnode-abi](/reference/airnode/v0.11/packages/airnode-abi.md) package.
