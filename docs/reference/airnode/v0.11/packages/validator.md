...
path: /reference/airnode/v0.11/packages/validator.html
version: v0.11
outline: deep
tags:
---
...
is used internally by the [Docker Images](/reference/airnode/v0.11/docker/) to
validate the
[configuration files](/reference/airnode/v0.11/understand/configuring.md) you
...
[validator CLI](/reference/airnode/v0.11/packages/validator.md#cli-usage), but
for advanced use cases you can use the
[validator SDK](/reference/airnode/v0.11/packages/validator.md#sdk-usage).
