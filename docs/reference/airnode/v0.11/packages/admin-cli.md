...
path: /reference/airnode/v0.11/packages/admin-cli.html
version: v0.11
outline: deep
tags:
---
...
[requester](/reference/airnode/v0.11/concepts/requester.md) contracts and derive
[sponsorWallets](/reference/airnode/v0.11/concepts/sponsor.md#sponsorwallet) for
Airnodes. API providers can build
[Airnodes](/reference/airnode/v0.11/concepts/airnode.md) that serve their API
...
[<span style="color:green;">Developer Fees</span>](/reference/airnode/v0.11/developers/fees.md)
doc.
...
[Chain Providers](/reference/airnode/v0.11/concepts/chain-providers.md) doc for
more information.
...
or the
[RequesterAuthorizerWithAirnode.sol](https://github.com/api3dao/airnode/blob/v0.11/packages/airnode-protocol/contracts/authorizers/RequesterAuthorizerWithAirnode.sol)
...
Commands related to a [sponsor's](/reference/airnode/v0.11/concepts/sponsor.md)
relationships between
[requesters](/reference/airnode/v0.11/concepts/requester.md) and
[sponsorWallets](/reference/airnode/v0.11/concepts/sponsor.md#sponsorwallet) as
well as [templates](/reference/airnode/v0.11/concepts/template.md) used by a
...
- [get-sponsor-status](/reference/airnode/v0.11/packages/admin-cli.md#get-sponsor-status)
- [derive-sponsor-wallet-address](/reference/airnode/v0.11/packages/admin-cli.md#derive-sponsor-wallet-address)
- [create-template](/reference/airnode/v0.11/packages/admin-cli.md#create-template)
- [create-inline-template](/reference/airnode/v0.11/packages/admin-cli.md#create-inline-template)
- [get-template](/reference/airnode/v0.11/packages/admin-cli.md#get-template)
- [request-withdrawal](/reference/airnode/v0.11/packages/admin-cli.md#request-withdrawal)
- [check-withdrawal-request](/reference/airnode/v0.11/packages/admin-cli.md#check-withdrawal-request)
- [verify-airnode-xpub](/reference/airnode/v0.11/packages/admin-cli.md#verify-airnode-xpub)

### `sponsor-requester`

[Sponsors](/reference/airnode/v0.11/concepts/sponsor.md) a
[requester](/reference/airnode/v0.11/concepts/requester.md) contract so that its
requests can be fulfilled by the
[sponsorWallet](/reference/airnode/v0.11/concepts/sponsor.md#sponsorwallet) of
...
[relationship](/reference/airnode/v0.11/concepts/sponsor.md) between the
...
[sponsorWallet](/reference/airnode/v0.11/concepts/sponsor.md#sponsorwallet). The
...
[sponsor](/reference/airnode/v0.11/concepts/sponsor.md) and
[requester](/reference/airnode/v0.11/concepts/requester.md) (`true` if
...
[sponsor](/reference/airnode/v0.11/concepts/sponsor.md), which is called the
[sponsorWallet](/reference/airnode/v0.11/concepts/sponsor.md#sponsorwallet).
...
[template](/reference/airnode/v0.11/concepts/template.md) and returns a
`template-id`. Also see
[Using Templates](/reference/airnode/v0.11/developers/using-templates.md) for an
...
[template](/reference/airnode/v0.11/concepts/template.md) and returns the data
...
Returns the [template](/reference/airnode/v0.11/concepts/template.md) for the
given `template-id`.
...
Requests a
[withdrawal](/reference/airnode/v0.11/concepts/sponsor.md#withdrawals) from a
[sponsorWallet](/reference/airnode/v0.11/concepts/sponsor.md#sponsorwallet)
...
[sponsor](/reference/airnode/v0.11/concepts/sponsor.md) for the specified
...
[withdrawal](/reference/airnode/v0.11/concepts/sponsor.md#withdrawals) request
with the given `withdrawal-request-id` from the
[request withdrawal command](/reference/airnode/v0.11/packages/admin-cli.md#request-withdrawal)
above.
...
[xpub](/reference/airnode/v0.11/concepts/airnode.md#xpub) with default
derivation path `m/44'/60'/0'/0/0` and compares it with the `airnode-address`.
This command will most likely be used by a
[sponsor](/reference/airnode/v0.11/concepts/sponsor.md) to verify that the xpub
...
([xpub](/reference/airnode/v0.11/concepts/airnode.md#xpub)). This xpub must be
...
Derives an
[endpointId](/reference/airnode/v0.11/deployment-files/config-json.md#triggers)
from the OIS title and the endpoint's name as described in the
[endpoint](/reference/airnode/v0.11/concepts/endpoint.md) documentation. Add the
...
[airnode wallet](/reference/airnode/v0.11/concepts/airnode.md#mnemonic). In
addition to the mnemonic, this command will also display the corresponding
[airnode address](/reference/airnode/v0.11/concepts/airnode.md#airnodeaddress)
and its extended public key
([xpub](/reference/airnode/v0.11/concepts/airnode.md#xpub)).
...
[authorizer](/reference/airnode/v0.11/concepts/authorizers.md) contract that can
...
[requesters](/reference/airnode/v0.11/concepts/requester.md) where each Airnode
...
- [extend-whitelist-expiration](/reference/airnode/v0.11/packages/admin-cli.md#extend-whitelist-expiration)
- [set-indefinite-whitelist-status](/reference/airnode/v0.11/packages/admin-cli.md#set-indefinite-whitelist-status)
- [get-whitelist-status](/reference/airnode/v0.11/packages/admin-cli.md#get-whitelist-status)
- [is-requester-whitelisted](/reference/airnode/v0.11/packages/admin-cli.md#is-requester-whitelisted)
