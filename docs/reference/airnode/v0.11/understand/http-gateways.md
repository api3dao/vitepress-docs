...
path: /reference/airnode/v0.11/understand/http-gateways.html
version: v0.11
outline: deep
tags:
---
...
[heartbeat](/reference/airnode/v0.11/understand/heartbeat.md) to a specified
heartbeat URL.
...
[Docker image](/reference/airnode/v0.11/docker/deployer-image.md).
...
[Airnode client usage](/reference/airnode/v0.11/docker/client-image.md#usage)
for more details.
...
[Airnode ABI](/reference/airnode/v0.11/specifications/airnode-abi.md).
...
[Docker image](/reference/airnode/v0.11/docker/).
...
values: an array of values after they are [extracted and converted](/reference/airnode/v0.11/packages/adapter.md#conversion) to the target type
