...
path: /reference/airnode/v0.11/concepts/authorizations.html
version: v0.11
outline: deep
tags:
---
...
[Authorizers](/reference/airnode/v0.11/concepts/authorizers.md) can supersede
...
[Authorizers](/reference/airnode/v0.11/concepts/authorizers.md) or
[Relayed Meta Data](/reference/airnode/v0.11/concepts/relay-meta-auth.md). It is
