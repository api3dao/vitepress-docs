...
path: /reference/airnode/v0.11/concepts/request.html
version: v0.11
outline: deep
tags:
---
...
[requester](/reference/airnode/v0.11/concepts/requester.md), to either the
`makeFullRequest()` or `makeTemplateRequest()` functions of the
[AirnodeRrpV0.sol](/reference/airnode/v0.11/concepts/index.md#airnoderrpv0-sol)
protocol contract which adds the request to its storage. The targeted off-chain
[Airnode](/reference/airnode/v0.11/concepts/airnode.md) gathers the request from
...
[Call an Airnode](/reference/airnode/v0.11/developers/index.md).
...
- `parameters` specify the API and
  [reserved](/reference/ois/2.1/specification.md#_5-4-reservedparameters)
  parameters (see
...
- [Fulfill](/reference/airnode/v0.11/concepts/request.md#fulfill)
- [Fail](/reference/airnode/v0.11/concepts/request.md#fail)
