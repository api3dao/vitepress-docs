...
path: /reference/airnode/v0.11/concepts/relay-meta-auth.html
version: v0.11
outline: deep
tags:
---
...
see [Building an Airno/reference/airnode/v0.11/understand/). Then have your API
...
[Simple Example](/reference/airnode/v0.11/concepts/relay-meta-auth.md#simple-example)
