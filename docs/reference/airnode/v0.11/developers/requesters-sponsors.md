...
path: /reference/airnode/v0.11/developers/requesters-sponsors.html
version: v0.11
outline: deep
tags:
---
...
The term [requester](/reference/airnode/v0.11/concepts/requester.md) is
...
[Overview](/reference/airnode/v0.11/concepts/) doc, it is a requester.

## What is a Sponsor?

Equally important is the term
[sponsor](/reference/airnode/v0.11/concepts/sponsor.md). A sponsor is an entity
...
A [sponsorAddress](/reference/airnode/v0.11/concepts/sponsor.md#sponsoraddress)
...
[API Provider Fees](/reference/airnode/v0.11/developers/fees.md#api-provider-fees).

## Admin CLI Commands

There are several sponsor and requester related commands in the
[Admin CLI Commands](/reference/airnode/v0.11/packages/admin-cli.md) package.
...
1. [sponsor-requester](/reference/airnode/v0.11/packages/admin-cli.md#sponsor-requester)
   sponsors a requester.
2. [derive-sponsor-wallet-address](/reference/airnode/v0.11/packages/admin-cli.md#derive-sponsor-wallet-address)creates
