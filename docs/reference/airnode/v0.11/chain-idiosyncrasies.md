...
path: /reference/airnode/v0.11/chain-idiosyncrasies.html
version: v0.11
outline: deep
tags:
---
...
in
[Configuring Airnode](/reference/airnode/v0.11/understand/configuring.md#chains)
and
[Deployment Files](/reference/airnode/v0.11/deployment-files/config-json.md#chains)
section.
...
which are
[accounted for separately](https://docs.optimism.io/stack/transactions/fees)).
To cover the L1 data fee when a sponsor requests a
[withdrawal](/reference/airnode/v0.11/concepts/sponsor.md#withdrawals), an
