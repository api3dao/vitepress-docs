...
path: /reference/airnode/v0.12/developers/fees.html
version: v0.12
outline: deep
tags:
---
...
certain [admin commands](/reference/airnode/v0.12/packages/admin-cli.md) as
shown below.
...
- [Calling](/reference/airnode/v0.12/developers/index.md) an Airnode:
...
Learn more about [sponsor wallets](/reference/airnode/v0.12/concepts/sponsor.md)
...
[Calling an Airnode](/reference/airnode/v0.12/developers/index.md) to learn more
