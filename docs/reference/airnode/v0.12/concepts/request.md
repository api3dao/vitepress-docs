...
path: /reference/airnode/v0.12/concepts/request.html
version: v0.12
outline: deep
tags:
---
...
[requester](/reference/airnode/v0.12/concepts/requester.md), to either the
`makeFullRequest()` or `makeTemplateRequest()` functions of the
[AirnodeRrpV0.sol](/reference/airnode/v0.12/concepts/index.md#airnoderrpv0-sol)
protocol contract which adds the request to its storage. The targeted off-chain
[Airnode](/reference/airnode/v0.12/concepts/airnode.md) gathers the request from
...
[Call an Airnode](/reference/airnode/v0.12/developers/index.md).
...
- [Fulfill](/reference/airnode/v0.12/concepts/request.md#fulfill)
- [Fail](/reference/airnode/v0.12/concepts/request.md#fail)
