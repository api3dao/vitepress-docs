...
path: /reference/airnode/v0.12/concepts/authorizers.html
version: v0.12
outline: deep
tags:
---
...
- [RequesterAuthorizerWithAirnode](/reference/airnode/v0.12/concepts/authorizers.md#requesterauthorizerwithairnode)
- [RequesterAuthorizerWithManager](/reference/airnode/v0.12/concepts/authorizers.md#requesterauthorizerwithmanager)
...
be done using the
[admin-cli](/reference/airnode/v0.12/packages/admin-cli.md#requesterauthorizerwithairnode).
...
[chains[n].authorizers](/reference/airnode/v0.12/understand/configuring.md#chains).
...
[Authorizations](/reference/airnode/v0.12/concepts/authorizations.md) or
[Relayed Meta Data Security Schemes](/reference/airnode/v0.12/concepts/relay-meta-auth.md).
...
[config.json reference](/reference/airnode/v0.12/deployment-files/config-json.md#chains).
...
[here](/reference/airnode/v0.12/). Lastly, `chainId` specifies the cross-chain
...
[here](/reference/airnode/v0.12/). In the example below, a request would be
...
[Airnode Contract Addresses](/reference/airnode/v0.12/index.md#requesterauthorizerwitherc721)
page.
...
[here](/reference/airnode/v0.12/). If multiple ERC721 contracts are specified in
