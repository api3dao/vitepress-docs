...
path: /reference/airnode/v0.12/concepts/index.html
version: v0.12
outline: deep
tags:
---
...
[requester](/reference/airnode/v0.12/concepts/requester.md) and the Airnode. It
...
contract. See the [Airnode Contract Addresses](/reference/airnode/v0.12/) for
reference.

The [`@api3/airnode-admin`](/reference/airnode/v0.12/packages/admin-cli.md)
...
The
[IAirnodeRrpV0.sol](https://github.com/api3dao/airnode/blob/v0.12/packages/airnode-protocol/contracts/rrp/interfaces/IAirnodeRrpV0.sol)
...
[Authorizer](/reference/airnode/v0.12/concepts/authorizers.md) checks.
...
contract allows the [sponsor](/reference/airnode/v0.12/concepts/sponsor.md) to
...
[templates](/reference/airnode/v0.12/concepts/template.md) used to create a
[template request](/reference/airnode/v0.12/concepts/request.md#template-request).
