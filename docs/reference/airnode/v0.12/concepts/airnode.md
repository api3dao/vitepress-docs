...
path: /reference/airnode/v0.12/concepts/airnode.html
version: v0.12
outline: deep
tags:
---
...
([RRP](/reference/airnode/v0.12/developers/)).
...
[requesters](/reference/airnode/v0.12/concepts/requester.md) (which are on-chain
...
cases. See the the
[Calling Airnode (RRP)](/reference/airnode/v0.12/developers/index.md) for more
...
[address](/reference/airnode/v0.12/concepts/airnode.md#airnodeaddress) derived
from the mnemonic.
...
specified in the
[secrets.env](/reference/airnode/v0.12/deployment-files/secrets-env.md) file
...
[sponsor wallet](/reference/airnode/v0.12/concepts/sponsor.md#sponsorwallet) for
...
[verify-xpub](/reference/airnode/v0.12/packages/admin-cli.md#verify-airnode-xpub)
