...
path: /reference/airnode/v0.12/understand/api-integration.html
version: v0.12
outline: deep
tags:
---
...
With regards to the [OIS template](/reference/ois/2.1/template.md), the name of
...
[fixed operation parameters](/reference/airnode/v0.12/understand/api-integration.md#fixedoperationparameters)).
...
[templates](/reference/airnode/v0.12/concepts/template.md) (not to be confused
