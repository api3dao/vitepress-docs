...
path: /reference/airnode/v0.12/packages/adapter.html
version: v0.12
outline: deep
tags:
---
...
[Oracle Integration Specification (OIS)](/reference/ois/2.1/), executing them,
...
2. The value to be converted is extracted from the response using the
   [\_path](/reference/ois/2.1/reserved-parameters.md#path) from the OIS object.
...
4. The converted value is encoded to the native solidity type based on the
   [\_type](/reference/ois/2.1/reserved-parameters.md#type) from the OIS object.
...
[\_times](/reference/ois/2.1/reserved-parameters.md#times) parameter if it is
present.
...
[`_times`](/reference/ois/2.1/reserved-parameters.md#times) parameter that is
...
[`string32`](/reference/airnode/v0.12/packages/adapter.md#string32).
...
documentation for
[`string`](/reference/airnode/v0.12/packages/adapter.md#string).
...
- `int256[]` - has primitive type `int256`. All elements of this array follow
  the [`int256`](/reference/airnode/v0.12/packages/adapter.md#int256-or-uint256)
  rules.
- `string32[7][][5]` - is a multidimensional array, where some dimensions are
  ...
  converted based on
  [`string32`](/reference/airnode/v0.12/packages/adapter.md#string32) rules.
