    ...
    items: [
      {
        ...
        link: '/reference/airnode/next/guides/setting-up-airnode/',
      },
      {
        ...
        items: [
          {
            ...
            link: ' /reference/airnode/next/guides/deploy-airnode/deploy-aws/',
          },
          {
            text: '• Deploying Airnode via GCP',
            link: '/reference/airnode/next/guides/deploy-airnode/deploy-gcp/',
          },
          {
            text: '• Deploying Airnode locally using Docker',
            link: '/reference/airnode/next/guides/deploy-airnode/deploy-container/',
          },
          {
            text: '• Generating Airnode Config using ChainAPI',
            link: '/reference/airnode/next/guides/deploy-airnode/generate-config-chainapi/',
          },
        ],
      },
      {
        text: 'Calling an Airnode',
        link: '/reference/airnode/next/guides/calling-an-airnode/',
      },
      {
        text: 'Post processing',
        link: '/reference/airnode/next/guides/post-processing/',
      },
      {
        text: 'Making an RRP Request',
        link: '/reference/airnode/next/guides/rrp-request',
      },
      {
        text: 'Making RRP Template Requests',
        link: '/reference/airnode/next/guides/using-rrp-templates',
      },
      {
        text: 'Monorepo Examples',
        link: '/reference/airnode/next/guides/monorepo-examples',
      },
    ],
  },
];
