...
[Airnode monorepo](https://github.com/api3dao/airnode/tree/v0.14/packages) has
...
- [airnode-admin:](https://github.com/api3dao/airnode/tree/v0.14/packages/airnode-admin)
  A package/CLI tool to interact with the Airnode contracts across chains.

- [airnode-abi:](https://github.com/api3dao/airnode/tree/v0.14/packages/airnode-abi)
...
- [airnode-deployer:](https://github.com/api3dao/airnode/tree/v0.14/packages/airnode-deployer)
  Tools to automate Airnode deployment.

- [airnode-examples:](https://github.com/api3dao/airnode/tree/v0.14/packages/airnode-examples)
  A public list of examples showcasing the features of Airnode.

- [airnode-node:](https://github.com/api3dao/airnode/tree/v0.14/packages/airnode-node)
  The node part of Airnode that allows for connecting multiple blockchains to
  the rest of the world.

- [airnode-operation:](https://github.com/api3dao/airnode/tree/v0.14/packages/airnode-operation)
...
- [airnode-validator:](https://github.com/api3dao/airnode/tree/v0.14/packages/airnode-validator)
