...
- [chains](/reference/airnode/next/deployment-files/config-json.md#chains):
  Blockchains the Airnode deployment will serve on and configuration details
- [nodeSettings](/reference/airnode/next/deployment-files/config-json.md#nodesettings):
  General deployment parameters such as node version and deployment
  configuration.
- [triggers](/reference/airnode/next/deployment-files/config-json.md#triggers):
...
[AirnodeRrpV0](/reference/airnode/next/concepts/#airnoderrpv0-sol) contract
should use on-chain. Learn more about authorizers in
[Authorizers](/reference/airnode/next/concepts/authorizers.md) and
[Using Authorizers](/reference/airnode/next/understand/apply-auth.md).
...
[Authorizations](/reference/airnode/next/concepts/authorizations.md) and
...
[Airnode Contract Addresses](/reference/airnode/next/).
...
[Chain Providers](/reference/airnode/next/concepts/chain-providers.md).
...
[Configuring an Airnode](/reference/airnode/next/understand/configuring.md#chains)
...
[withdrawal](/reference/airnode/next/concepts/sponsor.md#withdrawals). Defaults
to zero and is relevant only for some chains (e.g.
[Optimism](/reference/airnode/next/chain-idiosyncrasies.md#optimism)).
...
[<span style="color: rgb(16, 185, 129)">Gas Price Strategies</span>](/reference/airnode/next/concepts/gas-prices.md)
...
[disableConcurrencyReservations](/reference/airnode/next/deployment-files/config-json.md#cloudprovider-disableconcurrencyreservations).

See
[Configuring an Airnode](/reference/airnode/next/understand/configuring.md#considerations-concurrency)
...
[Cloud Resources](/reference/airnode/next/cloud-resources.md) documentation.

#### `cloudProvider.type`

(required) - Currently `aws` and `gcp` are supported for serverless
([deployer-image](/reference/airnode/next/docker/deployer-image.md)). Use
`local` to run Airnode as a docker container locally
([client-image](/reference/airnode/next/docker/client-image.md)).
...
[list of regions](/reference/airnode/next/cloud-resources.md#supported-regions)
...
[address](/reference/airnode/next/concepts/airnode.md#airnodeaddress) will be
derived. It is not required to fund the wallet to run the Airnode but must be
funded to announce the [xpub](/reference/airnode/next/concepts/airnode.md#xpub)
...
[Heartbeat](/reference/airnode/next/understand/heartbeat.md) documentation for
more information.
...
auction. See the
[OEV Gateway](/reference/airnode/next/understand/oev-gateway.md) documentation
for more info.
...
[request](/reference/airnode/next/concepts/request.md) that references its
...
the RRP protocol [AirnodeRrpV0.sol](/reference/airnode/next/concepts/).
...
[Considerations: cached responses](/reference/airnode/next/understand/configuring.md#considerations-cached-responses).
...
[Template Requests](/reference/airnode/next/concepts/request.md#template-request).
...
[Using Templates](/reference/airnode/next/developers/using-templates.md).
...
derivation see:
[Templates](/reference/airnode/next/concepts/template.md#templateid).
...
the [API Security](/reference/airnode/next/understand/api-security.md)
documentation.
