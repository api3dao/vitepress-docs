...
path: /reference/airnode/v0.13/developers/index.html
version: v0.13
outline: deep
tags:
---
...
sponsor wallet. See
[Requesters and Sponsors](/reference/airnode/v0.13/developers/requesters-sponsors.md)
...
- Call `makeFullRequest()` or `makeTemplateRequest()` on the AirnodeRrpV0.sol
  ...
  [`requestId`](/reference/airnode/v0.13/concepts/request.md#requestid).
...
([A simplified understanding](/reference/airnode/v0.13/developers/index.md#a-simplified-understanding))
