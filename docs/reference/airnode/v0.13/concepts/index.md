...
path: /reference/airnode/v0.13/concepts/index.html
version: v0.13
outline: deep
tags:
---
...
[requester](/reference/airnode/v0.13/concepts/requester.md) and the Airnode. It
inherits from four additional contracts as illustrated in the diagram above:

- [IAirnodeRrpV0.sol](/reference/airnode/v0.13/concepts/index.md#iairnoderrpv0-sol)
- [AuthorizationUtilsV0.sol](/reference/airnode/v0.13/concepts/index.md#authorizationutilsv0-sol)
- [WithdrawalUtilsV0.sol](/reference/airnode/v0.13/concepts/index.md#withdrawalutilsv0-sol)
- [TemplateUtilsV0.sol](/reference/airnode/v0.13/concepts/index.md#templateutilsv0-sol)
...
contract. See the [Airnode Contract Addresses](/reference/airnode/v0.13/) for
reference.

The [`@api3/airnode-admin`](/reference/airnode/v0.13/packages/admin-cli.md)
...
[Authorizer](/reference/airnode/v0.13/concepts/authorizers.md) checks.
...
contract allows the [sponsor](/reference/airnode/v0.13/concepts/sponsor.md) to
...
[templates](/reference/airnode/v0.13/concepts/template.md) used to create a
[template request](/reference/airnode/v0.13/concepts/request.md#template-request).
