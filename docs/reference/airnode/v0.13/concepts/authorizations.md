...
path: /reference/airnode/v0.13/concepts/authorizations.html
version: v0.13
outline: deep
tags:
---
...
[Authorizers](/reference/airnode/v0.13/concepts/authorizers.md) can supersede
...
[Authorizers](/reference/airnode/v0.13/concepts/authorizers.md) or
[Relayed Meta Data](/reference/airnode/v0.13/concepts/relay-meta-auth.md). It is
...
[requesterEndpointAuthorizations](https://github.com/api3dao/airnode/blob/v0.13/packages/airnode-validator/src/config/config.ts#L162).
