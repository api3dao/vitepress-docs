...
path: /reference/airnode/v0.13/concepts/request.html
version: v0.13
outline: deep
tags:
---
...
[requester](/reference/airnode/v0.13/concepts/requester.md), to either the
`makeFullRequest()` or `makeTemplateRequest()` functions of the
[AirnodeRrpV0.sol](/reference/airnode/v0.13/concepts/index.md#airnoderrpv0-sol)
protocol contract which adds the request to its storage. The targeted off-chain
[Airnode](/reference/airnode/v0.13/concepts/airnode.md) gathers the request from
...
[Call an Airnode](/reference/airnode/v0.13/developers/index.md).
...
- `parameters` specify the API and
  [reserved](/reference/ois/2.2/specification.md#_5-4-reservedparameters)
  parameters (see
  [Airnode ABI specifications](/reference/airnode/v0.13/specifications/airnode-abi.md)
...
- [Fulfill](/reference/airnode/v0.13/concepts/request.md#fulfill)
- [Fail](/reference/airnode/v0.13/concepts/request.md#fail)
