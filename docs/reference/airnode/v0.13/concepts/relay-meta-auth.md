...
path: /reference/airnode/v0.13/concepts/relay-meta-auth.html
version: v0.13
outline: deep
tags:
---
...
see [Building an Airno/reference/airnode/v0.13/understand/). Then have your API
...
[Simple Example](/reference/airnode/v0.13/concepts/relay-meta-auth.md#simple-example)
