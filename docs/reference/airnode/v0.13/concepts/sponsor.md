...
path: /reference/airnode/v0.13/concepts/sponsor.html
version: v0.13
outline: deep
tags:
---
...
[sponsorWallets](/reference/airnode/v0.13/concepts/sponsor.md#sponsorwallet).
...
1. The now "sponsored" requester makes a
   [request](/reference/airnode/v0.13/concepts/request.md) of an Airnode.
...
Each [Airnode](/reference/airnode/v0.13/concepts/airnode.md) can keep a
...
[derive](/reference/airnode/v0.13/concepts/sponsor.md#derive-a-sponsor-wallet) a
`sponsorWallet` for a particular Airnode.
[Requesters](/reference/airnode/v0.13/concepts/requester.md), that have been
...
[sponsorships](/reference/airnode/v0.13/developers/requesters-sponsors.md).

Use the
[Admin CLI tool](/reference/airnode/v0.13/packages/admin-cli.md#sponsor-requester)
to sponsor a requester. An example can be seem in the
[Requesters and Sponsors](/reference/airnode/v0.13/developers/requesters-sponsors.md#how-to-sponsor-a-requester)
doc.
...
and the [xpub](/reference/airnode/v0.13/concepts/airnode.md#xpub) of a
particular Airnode to derive a
[sponsorWallet](/reference/airnode/v0.13/concepts/sponsor.md#sponsorwallet) for
...
Use the
[Admin CLI tool](/reference/airnode/v0.13/packages/admin-cli.md#derive-sponsor-wallet-address)
to derive a `sponsorWallet`. An example can be seem in the
[Requesters and Sponsors](/reference/airnode/v0.13/developers/requesters-sponsors.md#how-to-derive-a-sponsor-wallet)
doc.
