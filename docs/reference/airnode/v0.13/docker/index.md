...
path: /reference/airnode/v0.13/docker/index.html
version: v0.13
outline: deep
tags:
---
...
- The [deployer image](/reference/airnode/v0.13/docker/deployer-image.md)
  deploys the node in the form of serverless functions to a serverless cloud
  provider (e.g. AWS Lambda).

- The [client image](/reference/airnode/v0.13/docker/client-image.md) is the
...
- The [admin CLI image](/reference/airnode/v0.13/docker/admin-cli-image.md)
