...
path: /reference/airnode/v0.13/understand/http-gateways.html
version: v0.13
outline: deep
tags:
---
...
[heartbeat](/reference/airnode/v0.13/understand/heartbeat.md) to a specified
heartbeat URL.
...
[Docker image](/reference/airnode/v0.13/docker/deployer-image.md).
...
[Airnode ABI](/reference/airnode/v0.13/specifications/airnode-abi.md).
...
values: an array of values after they are [extracted and converted](/reference/airnode/v0.13/packages/adapter.md#conversion) to the target type
