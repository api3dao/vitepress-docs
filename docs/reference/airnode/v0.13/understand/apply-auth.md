...
path: /reference/airnode/v0.13/understand/apply-auth.html
version: v0.13
outline: deep
tags:
---
...
endpoints using [Authorizers](/reference/airnode/v0.13/concepts/authorizers.md).
This method is on-chain and requires some blockchain knowledge by an API
provider.

## What is an authorizer?

An [Authorizer](/reference/airnode/v0.13/concepts/authorizers.md) is a contract
...
- Only serve your own
  [requester contracts](/reference/airnode/v0.13/developers/requesters-sponsors.md).
...
1. Add the RequesterAuthorizerWithAirnode
   [authorizer contract address](/reference/airnode/v0.13/#requesterauthorizerwithairnode)
