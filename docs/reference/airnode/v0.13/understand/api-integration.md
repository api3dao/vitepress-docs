...
path: /reference/airnode/v0.13/understand/api-integration.html
version: v0.13
outline: deep
tags:
---
...
([Oracle Integration Specifications](/reference/ois/2.2/specification.md)) json
...
- Open the [OIS template](/reference/ois/2.2/template.md) in another browser
...
[OIS template](/reference/ois/2.2/template.md) to construct an OIS and add it to
...
[OIS Specification](/reference/ois/2.2/specification.md#_1-oisformat) to be
used. For Airnode `v0.13`, the proper OIS version is `2.2.1`.
...
With regards to the [OIS template](/reference/ois/2.2/template.md), the name of
...
[fixed operation parameters](/reference/airnode/v0.13/understand/api-integration.md#fixedoperationparameters)).
...
[templates](/reference/airnode/v0.13/concepts/template.md) (not to be confused
...
[related OIS docs](/reference/ois/2.2/specification.md#_5-4-reservedparameters)
for more information.

The current list of reserved parameters are `_type`, `_path`, `_times`,
`_gasPrice`, and `_minConfirmations`. See
[Reserved Parameters](/reference/ois/2.2/reserved-parameters.md) in the OIS
document set to understand what each of these parameters are for.

#### parameters

Airnode endpoint
[parameters](/reference/ois/2.2/specification.md#_5-5-parameters) map to API
operation [parameters](/reference/ois/2.2/specification.md#_4-2-1-parameters)
