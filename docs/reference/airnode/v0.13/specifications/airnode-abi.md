...
path: /reference/airnode/v0.13/specifications/airnode-abi.html
version: v0.13
outline: deep
tags:
---
...
in depth in
[string32 details](/reference/airnode/v0.13/specifications/airnode-abi.md#string32)
section.
...
user should use the
[`bytes32`](/reference/airnode/v0.13/specifications/airnode-abi.md#bytes32) type
instead.
...
[`string32`](/reference/airnode/v0.13/specifications/airnode-abi.md#string32)
type instead.
...
[template](/reference/airnode/v0.13/concepts/template.md) pattern used in the
...
[airnode-abi](/reference/airnode/v0.13/packages/airnode-abi.md) package.
...
See the package doc
[airnode-abi](/reference/airnode/v0.13/packages/airnode-abi.md) for more
