...
path: /reference/airnode/v0.13/chain-idiosyncrasies.html
version: v0.13
outline: deep
tags:
---
...
in
[Configuring Airnode](/reference/airnode/v0.13/understand/configuring.md#chains)
and
[Deployment Files](/reference/airnode/v0.13/deployment-files/config-json.md#chains)
section.
...
[withdrawal](/reference/airnode/v0.13/concepts/sponsor.md#withdrawals), an
