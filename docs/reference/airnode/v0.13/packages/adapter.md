...
path: /reference/airnode/v0.13/packages/adapter.html
version: v0.13
outline: deep
tags:
---
...
[`string32`](/reference/airnode/v0.13/packages/adapter.md#string32).
...
documentation for
[`string`](/reference/airnode/v0.13/packages/adapter.md#string).
...
- `int256[]` - has primitive type `int256`. All elements of this array follow
  the [`int256`](/reference/airnode/v0.13/packages/adapter.md#int256-or-uint256)
  rules.
- `string32[7][][5]` - is a multidimensional array, where some dimensions are
  ...
  converted based on
  [`string32`](/reference/airnode/v0.13/packages/adapter.md#string32) rules.
