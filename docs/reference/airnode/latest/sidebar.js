    ...
    items: [
      {
        ...
        link: '/reference/airnode/latest/guides/setting-up-airnode/',
      },
      {
        ...
        items: [
          {
            ...
            link: ' /reference/airnode/latest/guides/deploy-airnode/deploy-aws/',
          },
          {
            text: '• Deploying Airnode via GCP',
            link: '/reference/airnode/latest/guides/deploy-airnode/deploy-gcp/',
          },
          {
            text: '• Deploying Airnode locally using Docker',
            link: '/reference/airnode/latest/guides/deploy-airnode/deploy-container/',
          },
          {
            text: '• Generating Airnode Config using ChainAPI',
            link: '/reference/airnode/latest/guides/deploy-airnode/generate-config-chainapi/',
          },
        ],
      },
      {
        text: 'Calling an Airnode',
        link: '/reference/airnode/latest/guides/calling-an-airnode/',
      },
      {
        text: 'Post processing',
        link: '/reference/airnode/latest/guides/post-processing/',
      },
      {
        text: 'Making an RRP Request',
        link: '/reference/airnode/latest/guides/rrp-request',
      },
      {
        text: 'Making RRP Template Requests',
        link: '/reference/airnode/latest/guides/using-rrp-templates',
      },
      {
        text: 'Monorepo Examples',
        link: '/reference/airnode/latest/guides/monorepo-examples',
      },
    ],
  },
];
