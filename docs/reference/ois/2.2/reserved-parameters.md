...
path: /reference/ois/2.2/reserved-parameters.html
version: v2.2
outline: deep
tags:
---
...
2. [Reserved parameters](/reference/ois/2.2/specification.md#_5-4-reservedparameters) -
...
- [`string32`](/reference/ois/2.2/reserved-parameters.md#string32-encoded-to-bytes32-on-chain)
- [`timestamp`](/reference/ois/2.2/reserved-parameters.md#timestamp-encoded-to-uint256-on-chain)
...
[Encoding Multiple Values](/reference/ois/2.2/reserved-parameters.md#encoding-multiple-values)
section below.
...
[<span style="color:rgb(16, 185, 129);">escape the separator</span>](/reference/ois/2.2/reserved-parameters.md#escaping-separators).
