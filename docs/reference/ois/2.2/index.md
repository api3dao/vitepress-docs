...
path: /reference/ois/2.2/index.html
version: v2.2
outline: deep
tags:
---
...
[Deployment Files](/reference/airnode/v0.13/deployment-files/config-json.md)
...
[Specification](/reference/ois/2.2/specification.md).
