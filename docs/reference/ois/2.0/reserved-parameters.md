...
[template](/reference/airnode/v0.11/concepts/template.md) that contains them, or
as an argument of the request-making methods of
[AirnodeRrpV0.sol](/reference/airnode/v0.11/concepts/#airnoderrpv0-sol). In
either case, these parameters are encoded using the
[AirnodeRrpV0 ABI](/reference/airnode/v0.11/specifications/airnode-abi.md).
...
the
[adapter package docs](/reference/airnode/v0.11/packages/adapter.md#conversion).
...
multiplication is [cast](/reference/airnode/v0.11/packages/adapter.md) to
`int256` afterwards.
...
[Airnode gas price strategies](/reference/airnode/v0.11/concepts/gas-prices.md)
with a specified gas price when Airnode
[fulfills](/reference/airnode/v0.11/concepts/request.md#fulfill) the request.
...
[encoded](/reference/airnode/v0.11/packages/airnode-abi.md#encode) as a
...
in
[config.json](/reference/airnode/v0.11/deployment-files/config-json.md#minconfirmations).
...
[testing gateway](/reference/airnode/v0.11/understand/deploying.md#testing-with-http-gateway)
